<div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 hover:shadow-md transition-shadow duration-200">
                        <div class="flex flex-col md:flex-row justify-between items-start gap-6">
                            ...
                            <div class="flex-1 order-2 md:order-1">
                                ...
                                <a href="#" class="inline-flex items-center text-white bg-blue-600 hover:bg-blue-700 font-medium rounded-lg text-sm px-5 py-2.5 transition-colors duration-200 shadow-sm">
                                    Read more
